...
def log_result(result_dir, operation, entity, total_time, count):
    ...
    result_file = os.path.join(result_dir, "mariadb_results.csv")
...
def main():
    ...
    cursor.close()
    conn.close()
    print(f"✅ Testy zakończone. Wyniki zapisane w '{result_dir}'")
